...
/* ============================================
   Fetch all progress for Week 2 (MATCHES WEEK 1)
============================================ */
...
export default function SupervisorWeek2Page() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        console.error("[Week2] load error:", err);
      } finally {
  ...
  async function setApproved(p: ProgDoc, next: boolean) {
    ...
    try {
      ...
      // -----------------------------
      // Check if ALL Week-2 tasks are approved
      // -----------------------------
      ...
      const sectionRef = doc(db, "users", p.traineeId, "sections", "week2");
